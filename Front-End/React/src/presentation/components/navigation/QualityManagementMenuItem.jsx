...
class QualityManagementMenuItem extends React.Component {
  render() {
    const entry = NavigationService.findMenuEntry(MENU_IDS.qualityManagement)
    return <BaseMenuItem entry={entry} {...this.props} />
  }
}

export default QualityManagementMenuItem
