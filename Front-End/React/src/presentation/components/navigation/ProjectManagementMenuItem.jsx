...
class ProjectManagementMenuItem extends React.Component {
  render() {
    const entry = NavigationService.findMenuEntry(MENU_IDS.projectManagement)
    return <BaseMenuItem entry={entry} {...this.props} />
  }
}

export default ProjectManagementMenuItem
